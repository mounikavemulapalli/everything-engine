...
//       .catch(() => alert("Backend server is not reachable."));
//   }, []);
...
//     reader.onload = async () => {
//       console.log(reader.result); // This will log the content of the selected JSON file
...
//         alert(response.data || "Questions uploaded successfully!");
...
//         value={file ? "" : undefined} // Clear file input visually
//       />
//       <button
